...
- Since we are using I2C for all our sensors, we will use 4 wires (Prefereably of different colors) to Vin, GND, SDA, SCL for all the sensors. The locations of these pins can be determined from either the text on sensors or the documentation
...
- Solder the Multiplexer to the PCB
